    ...
    <div class="wrap-block">
        <div class="content-block service-block">
            <div class="service-block">
                ...
                <p class="service-info-subtitle">拥有成熟技术团队，涵盖各个领域，实现定制化软件需求</p>
        ...
        <div class="content-block service-case">
            <div class="service-case">
                <div class="block-line"></div>
                <p class="case-title">我们的产品</p>
                <p class="case-subtitle">主攻web3d、多端业务类软件的制作</p>
                <div class="case-list">
    ...
    data() {
        return {
            serviceList: [
                {
                    description: '大数据',
                    path: require('../../assets/img/index/bigData.png')
                },
                {
                    description: '智能多媒体',
                    path: require('../../assets/img/index/media.png')
                },
                {
                    description: '互联网',
                    path: require('../../assets/img/index/internet.png')
                },
                {
                    description: '云计算',
                    path: require('../../assets/img/index/cloud.png')
                }
            ],
            serviceIdeaInfo:
            {
                ideaTitle: '社团宗旨',
                ideaSubtitle: 'ASSOCIATION PUROPOSE',
                ideaDesc: '创新,团结,奋进,提高,在实践中学习，在团队中协作，创造实用的作品'
            },
            serviceIdeaImg: [
                {
                    name: 'lefImg',
